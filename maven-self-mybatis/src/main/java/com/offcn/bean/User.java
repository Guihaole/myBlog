...
public class User implements Serializable {
    ...
    public User(Integer uid, String name, String phone, Integer age) {
        this.uid = uid;
        this.name = name;
        this.phone = phone;
        this.age = age;
    ...
    public User(String name, String phone, Integer age, Integer sex, String username, String password) {
        this.name = name;
        this.phone = phone;
        this.age = age;
        this.sex = sex;
    ...
    public User(Integer uid, String name, String phone, Integer age, Integer sex, String username, String password) {
        this.uid = uid;
        this.name = name;
        this.phone = phone;
        this.age = age;
